...
def fill_and_clean(input_path, linear_fill_in, outlier,
    ...
    df.loc[~(df['Space_Gap'].between(space_gap_lower, space_gap_upper)), 'Space_Gap'] = np.nan
    ...
    rows_to_delete = set()
    columns = ['Speed_FAV', 'Acc_FAV', 'Speed_LV', 'Acc_LV', 'Space_Gap', 'Speed_Diff', 'Time_Headway']
